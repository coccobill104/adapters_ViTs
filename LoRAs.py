...
class LoRASelfAttention(nn.Module):
    def __init__(self, original_attn: nn.MultiheadAttention, rank=4, alpha=4.0, q=True, k=False, v=False):
        '''
        q, k, v are bools, they indicate to which blocks to apply the lora
        '''
        super().__init__()
